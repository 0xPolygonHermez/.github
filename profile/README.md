...
|:--------|:-----|:----------------|
|mainnet  |[v0.6.2](https://github.com/0xPolygonHermez/zkevm-node/releases/tag/v0.6.2)|[v5.0.6](https://github.com/0xPolygonHermez/zkevm-prover/releases/tag/v5.0.6)|
