...
|:--------|:-----|:----------------|
|mainnet  |[v0.3.3](https://github.com/0xPolygonHermez/zkevm-node/releases/tag/v0.3.2)|[v3.0.0](https://github.com/0xPolygonHermez/zkevm-prover/releases/tag/v3.0.0)|
